...
<div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="#"> <i class="icon-dashboard"></i> <span class="label label-important">20</span>Activities</a> </li>
        <li class="bg_lg"> <a href="charts.html"> <i class="icon-signal"></i> Proposals</a> </li>
        <li class="bg_ly"> <a href="widgets.html"> <i class="icon-inbox"></i><span class="label label-success">101</span> Quotations </a> </li>
        <li class="bg_lo"> <a href="tables.html"> <i class="icon-th"></i> Reports</a> </li>
        <li class="bg_lo"> <a href="form-common.html"> <i class="icon-th-list"></i>Results</a> </li>
        <li class="bg_ls"> <a href="buttons.html"> <i class="icon-tint"></i>Merits</a> </li>
